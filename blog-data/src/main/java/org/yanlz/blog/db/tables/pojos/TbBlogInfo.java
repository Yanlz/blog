...
public class TbBlogInfo implements ITbBlogInfo {

	private static final long serialVersionUID = 1555593658;
	...
	public TbBlogInfo(TbBlogInfo value) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("TbBlogInfo (");
