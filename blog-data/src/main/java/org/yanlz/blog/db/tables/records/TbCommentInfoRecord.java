...
public class TbCommentInfoRecord extends UpdatableRecordImpl<TbCommentInfoRecord> implements Record7<ULong, Long, Long, String, Long, Timestamp, Timestamp>, ITbCommentInfo {

	private static final long serialVersionUID = -1411795327;
	...
	public Field<ULong> field1() {
		return TbCommentInfo.TB_COMMENT_INFO.COMMENT_ID;
	}
	...
	public Field<Long> field2() {
		return TbCommentInfo.TB_COMMENT_INFO.COMMENT_BLOG_ID;
	}
	...
	public Field<Long> field3() {
		return TbCommentInfo.TB_COMMENT_INFO.COMMENT_USER_ID;
	}
	...
	public Field<String> field4() {
		return TbCommentInfo.TB_COMMENT_INFO.COMMENT_CONTENT;
	}
	...
	public Field<Long> field5() {
		return TbCommentInfo.TB_COMMENT_INFO.PARENT_ID;
	}
	...
	public Field<Timestamp> field6() {
		return TbCommentInfo.TB_COMMENT_INFO.CREATED_TIME;
	}
	...
	public Field<Timestamp> field7() {
		return TbCommentInfo.TB_COMMENT_INFO.UPDATED_TIME;
	}
	 ...
	 */
	@Override
	public TbCommentInfoRecord value1(ULong value) {
		setCommentId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TbCommentInfoRecord value2(Long value) {
	 ...
	 */
	@Override
	public TbCommentInfoRecord value3(Long value) {
	 ...
	 */
	@Override
	public TbCommentInfoRecord value4(String value) {
	 ...
	 */
	@Override
	public TbCommentInfoRecord value5(Long value) {
		setParentId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TbCommentInfoRecord value6(Timestamp value) {
	 ...
	 */
	@Override
	public TbCommentInfoRecord value7(Timestamp value) {
	 ...
	 */
	@Override
	public TbCommentInfoRecord values(ULong value1, Long value2, Long value3, String value4, Long value5, Timestamp value6, Timestamp value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	...
	/**
	 * Create a detached TbCommentInfoRecord
	 */
	public TbCommentInfoRecord() {
		super(TbCommentInfo.TB_COMMENT_INFO);
	}

	/**
	 * Create a detached, initialised TbCommentInfoRecord
	 */
	public TbCommentInfoRecord(ULong commentId, Long commentBlogId, Long commentUserId, String commentContent, Long parentId, Timestamp createdTime, Timestamp updatedTime) {
		super(TbCommentInfo.TB_COMMENT_INFO);
