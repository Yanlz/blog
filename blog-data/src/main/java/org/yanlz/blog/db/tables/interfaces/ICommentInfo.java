...
public interface ICommentInfo extends Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface ICommentInfo
	 */
	public void from(org.yanlz.blog.db.tables.interfaces.ICommentInfo from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface ICommentInfo
	 */
	public <E extends org.yanlz.blog.db.tables.interfaces.ICommentInfo> E into(E into);
}
