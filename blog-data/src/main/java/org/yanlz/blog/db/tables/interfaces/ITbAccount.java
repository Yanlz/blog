...
public interface ITbAccount extends Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface ITbAccount
	 */
	public void from(org.yanlz.blog.db.tables.interfaces.ITbAccount from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface ITbAccount
	 */
	public <E extends org.yanlz.blog.db.tables.interfaces.ITbAccount> E into(E into);
}
